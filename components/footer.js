      ...
      <div className='bg-black text-white h-28'>
        <div className='global-margin h-full flex flex-row justify-end items-center'>
          <div className='text-[16px]'>
            The Property & Beyond Lab is part of the Dark Matter Labs ecosystem. It is affiliated
            with both{' '}
            <Link href='https://radiclecivics.cc/' className='underline'>
              Radicle Civics
            </Link>{' '}
            and{' '}
            <Link href='https://www.7gencities.org/' className='underline'>
              7GenCities
            </Link>{' '}
            missions.
